 ...
 */
package org.openmrs.module.cameroonappointmentresponseextension.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.CameroonAppointmentResponseExtensionController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class CameroonAppointmentResponseExtensionController {
